...
{block name='page_content'}
	<h1 class="page-subheading">
		{l s='Updating contact information' mod='facebookpsconnect'}
	</h1>
	...
	<section id="content" class="page-content">
		<form id="login-form" action="{$sFormSubmit|escape:'htmlall':'UTF-8'}" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<input type="email" required="true" class="form-control" id="email" name="email" value="" />
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					<a href="{$sMyAccountLink|escape:'htmlall':'UTF-8'}" class="account-link"><i class="material-icons">&#xE5CB;</i><span>{l s='Back to your account' mod='facebookpsconnect'}</span></a>
				</div>
				<div class="col-md-9">
