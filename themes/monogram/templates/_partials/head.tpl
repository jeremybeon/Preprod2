...
{block name='head_seo'}
  ...
  {**Erruer W3C Alexandre Carette 16/02/2023**}
...
{block name='stylesheets'}
  ...
  <link rel="stylesheet" href="{$urls.css_url}slick.css" type="text/css" media="all" />
  <link rel="stylesheet" href="{$urls.css_url}monogram.css" type="text/css" media="all" />
{/block}
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-150270730-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){ dataLayer.push(arguments); }
  gtag('js', new Date());

  gtag('config', 'UA-150270730-1');
</script>
