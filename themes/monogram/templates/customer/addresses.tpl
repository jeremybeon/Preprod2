...
{block name='page_content'}
  <div class="custom_accountpage">
    {if $page.page_name == 'address'}
      <div class="pagetitle">
            <h1 class="page_title sub_page_title">
              <span class="backtoprevpage" onclick="javascript:window.history.back();"></span>
    ...
    {/if}
    <div class="customer_addresses row">
      {foreach $customer.addresses as $address}
        <div class="addresses_item col-xs-12 col-lg-12 col-md-12 col-sm-12">
      ...
      <div class="addresses-footer">
        <div class="addresses-footer_link col-xs-12 col-sm-12 col-md-12">
